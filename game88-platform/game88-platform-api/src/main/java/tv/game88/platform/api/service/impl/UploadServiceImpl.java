...
public class UploadServiceImpl implements UploadService {
    ...
    @Override
    public RspBase<?> upload( MultipartFile file, String path ) throws IOException {
        ConfigOss configOss = configOssCacheUtil.getEffect();
        return this.updateByProvider( file, path, configOss );
    }

    @Override
    public RspBase<?> uploadTest( MultipartFile file, long id ) throws IOException {
        ConfigOss configOss = configOssMapper.selectById( id );
        return this.updateByProvider( file, "test", configOss );
    }

    private RspBase<?> updateByProvider( MultipartFile file, String path, ConfigOss configOss ) throws IOException {
        ...
        String      fileKey        = profile + "/" + path + "/" + rFileName + "." + extension;
