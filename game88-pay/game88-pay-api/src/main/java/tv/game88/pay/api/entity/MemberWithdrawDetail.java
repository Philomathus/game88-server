...
public class MemberWithdrawDetail {
    ...
    @Excel( name = "提现订单号", orderNum = "0" )
    private String     withdrawOrderNo;
    @Excel( name = "会员编号", orderNum = "1" )
    private String     memberId;
    @Excel( name = "提现金额", orderNum = "2" )
    private BigDecimal withdrawMoney;
    @Excel( name = "银行ID", orderNum = "3" )
    private String     bankId;
    @Excel( name = "提现账号", orderNum = "4" )
    private String     bankAccount;
    @Excel( name = "开户地", orderNum = "5" )
    private String     bankAddress;
    @Excel( name = "开户银行真实姓名", orderNum = "6" )
    private String     bankUserName;
    // zhuangt
    //0申请中 1锁定 2审核不通过 3人工入款成功 4代付中 5代付失败 6代付成功
    private Integer    status;
    @Excel( name = "会员状态", orderNum = "8" )
    private Integer    memberStatus;
    @Excel( name = "操作人", orderNum = "9" )
    private String     opName;
    @Excel( name = "备注", orderNum = "10" )
    private String     remark;
    @Excel( name = "是否首次", orderNum = "11" )
    private boolean    first = false;
    @Excel( name = "入款出款比", orderNum = "12" )
    private BigDecimal rechargeWithdrawRate;
    @Excel( name = "公司入款成功次数", orderNum = "13" )
    private Integer    bankRechargeNum;
    @Excel( name = "真实银行卡地址(省/市)" )
