...
public class PayCallBackController {
    ...
    public String callbackPost( @PathVariable( "payCode" ) String payCode ) throws Exception {
    ...
    public String callbackForm( @PathVariable( "payCode" ) String payCode ) throws Exception {
        String                realIp     = ServletUtil.getIp();
        Map<String, String[]> requestMap = ServletUtil.getHttpServletRequest().getParameterMap();
        Map<String, Object>   map        = new HashMap<>();
        requestMap.forEach( ( k, v ) -> map.put( k, v[ 0 ] ) );
    ...
    public String callbackJson( @RequestBody Map<String, Object> requestMap, @PathVariable( "payCode" ) String payCode ) throws Exception {
        String  realIp  = ServletUtil.getIp();
        BasePay basePay = payProcessorFactoryUtil.createPayProcessor( payCode );
    ...
    public String callbackGet( @PathVariable( "payCode" ) String payCode ) throws Exception {
        String                realIp     = ServletUtil.getIp();
        Map<String, String[]> requestMap = ServletUtil.getHttpServletRequest().getParameterMap();
        Map<String, Object>   map        = new HashMap<>();
        requestMap.forEach( ( k, v ) -> map.put( k, v[ 0 ] ) );
    ...
    public String callbackText( @RequestBody String body, @PathVariable( "payCode" ) String payCode ) throws Exception {
        String              realIp = ServletUtil.getIp();
        Map<String, Object> map    = new HashMap<>();
        map.put( "data", body );
        BasePay basePay = payProcessorFactoryUtil.createPayProcessor( payCode );
