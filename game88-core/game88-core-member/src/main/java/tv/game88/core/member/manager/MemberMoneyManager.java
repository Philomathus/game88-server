...
public class MemberMoneyManager {
    ...
    @Transactional(rollbackFor = Exception.class)
    public void addMemberMoneyStarSend(MemberMoney memberMoney, MemberInfo memberInfo,
                                       String markOrder, String adminName, String moneyDes) {
