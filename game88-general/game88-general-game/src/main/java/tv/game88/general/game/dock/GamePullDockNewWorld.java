...
public class GamePullDockNewWorld extends AbstractGamePull {
    ...
    public List<Map<String, Object>> requestRemoteGameData( GamePlatform gamePlatform ) {
        ...
        if ( ! CollectionUtils.isEmpty( resultMap ) ) {
            Map<String, Object> dataStr = ( Map<String, Object> ) resultMap.getOrDefault( "dataStr", new
                    HashMap<>() );
            List<Map<String, Object>> contentsMapList = ( List<Map<String, Object>> ) dataStr.getOrDefault( "contents", new ArrayList<HashMap<String, Object>>() );
