...
public class Convert {
    ...
    public static String digitUppercase( double n ) {
        ...
        for ( int i = 0; i < fraction.length; i++ ) {
            s.append( ( digit[ ( int ) ( Math.floor( n * 10 * Math.pow( 10, i ) ) % 10 ) ]
     ...
     * @param rate
     */
    public static String rateConversion( BigDecimal rate ) {
        return rate.multiply( ONE_HUNDRED ).setScale( 4, RoundingMode.HALF_UP ).stripTrailingZeros().toPlainString()
                   .concat( "%" );
    }
}
