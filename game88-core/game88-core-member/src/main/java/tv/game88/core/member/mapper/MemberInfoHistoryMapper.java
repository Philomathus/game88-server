...
public interface MemberInfoHistoryMapper extends  BaseMapper<MemberInfoHistory> {
    /**
     * 查询会员表列表
     *
     * @param memberInfoHistory 会员表
     *
     * @return 会员表集合
     */
    ...
    MemberInfoHistory findMemberHistoryByMobile( String mobile );
    ...
    int updateVipById( MemberInfoHistory memberInfo );
    ...
    Map listCountMemberHistory( MemberInfoHistory req );
