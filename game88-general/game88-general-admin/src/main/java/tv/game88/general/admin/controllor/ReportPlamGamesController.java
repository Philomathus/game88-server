...
public class ReportPlamGamesController extends BaseController {
    ...
    @GetMapping( "/export" )
    public RspBase<List<ReportPlamGames>> export( ReportPlamGames reportPlamGames ) {
        return RspBase.ok( reportPlamGamesService.exportPlamGamesList( reportPlamGames ) );
    }
