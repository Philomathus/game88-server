...
@Repository( value = ConstantsPay.JU8_PAY + "Processor" )
@Log4j2
public class Ju8PayProcessor extends AbstractPay {
    ...
    public String orderPay( PayChannel payChannel, PayPlatform payPlatform, ReqPayRecharge reqPayRecharge ) throws Exception {
        ...
        params.put( "reqTime", LocalDateTimeUtils.format( LocalDateTime.now(), LocalDateTimeUtils.LOCALTIME_SP_NOM_FORMATTER ) );
